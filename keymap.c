...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYM_LAYER] = LAYOUT_split_3x5_2(
    ...
    QK_GESC, KC_PIPE, TD(TD_LBRC_GLB), LGUI_T(KC_LCBR), KC_LPRN, KC_COLN, KC_AT, KC_TILD, KC_MINS, KC_EQL,
    TO(FUNC_LAYER), KC_NUBS, TD(TD_RBRC_GRB), KC_RCBR, KC_RPRN, KC_SCLN, KC_QUOT, KC_HASH, KC_BSLS, KC_SLSH,
